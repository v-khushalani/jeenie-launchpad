  ...
  return (
    <div className="mobile-app-shell bg-background">
      ...
      <div className="mobile-app-shell-content-fit relative z-10">
        <div className="container mx-auto px-3 sm:px-4 lg:px-8 max-w-7xl h-full py-2 sm:py-3 flex flex-col">
                      ...
                      return (
                        <div key={subName} className={`group relative overflow-hidden rounded-2xl bg-card border-2 border-l-4 border-l-[#e6eeff] ${meta.border} sm:hover:scale-105 transition-all duration-300 cursor-pointer shadow-md sm:shadow-lg sm:hover:shadow-xl min-h-[9.5rem] sm:min-h-[13.5rem]`} onClick={() => handleSubjectClick(subName)}>
                          ...
                          <div>
                            ...
                            <h3 className="text-sm sm:text-2xl font-bold mb-1 sm:mb-2 text-foreground">{subName}</h3>
                            <p className="hidden sm:block text-muted-foreground text-xs sm:text-sm mb-3 sm:mb-4">Practice {subName} chapter by chapter</p>
            ...
            <Card className="border-2 border-primary/20 shadow-lg bg-card overflow-hidden flex-1 min-h-0 flex flex-col">
              ...
              <CardContent className="p-3 sm:p-6 min-h-0 flex-1 flex flex-col">
                {isLoading ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3 min-h-0 overflow-y-auto pr-1 sm:pr-2">
                    {chapters.map((ch, i) => (
              ...
              <CardContent className="p-3 sm:p-6 min-h-0 flex-1 flex flex-col">
                {isLoading ? (
                  ...
                  <div className="space-y-3 min-h-0 flex flex-col">
                    {selectedChapter && (
                      <div className="p-3 sm:p-6 rounded-xl bg-gradient-to-r from-primary/10 to-purple-50 dark:to-purple-950/20 border-2 border-primary/20 shadow-md shrink-0">
